...
public class AlterInfoMessage {
    ...
    public String toString() {
        return "AlterInfoMessage{" +
                ...
                ", delstatus=" + delstatus +
                ", sysmessagecol1='" + sysmessagecol1 + '\'' +
                ", sysmessagecol2='" + sysmessagecol2 + '\'' +
                ", sysmessagecol3='" + sysmessagecol3 + '\'' +
                ", sysmessagecol4='" + sysmessagecol4 + '\'' +
                ", sysmessagecol5='" + sysmessagecol5 + '\'' +
